...
const (
	heartbeatPath = "/lancache-heartbeat"
...
func (s *Server) serveHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if !known {
		...
		http.Error(w, "forbidden: host is not a LanCache service", http.StatusForbidden)
		return
	}
...
// heartbeat answers the LanCache detection probe (any Host, incl. IP
// literals).
...
// allowed to force refetches (lancache.nocacheClients).
