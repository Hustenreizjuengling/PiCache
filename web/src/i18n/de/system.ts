...
// Audit-Log, Anwendungsprotokoll, Logs & Datenschutz, Sicherung &
...
const de: Messages<typeof en> = {
  ...
  'logs.saveBar': 'Nicht gespeicherte Log-Einstellungen',
  'logs.unsaved': 'Du hast die Log-Einstellungen geändert. Speichere sie, damit sie gelten.',
  'logs.level.title': 'Datenschutzstufe',
  'logs.level.description': 'Was PiCache über die DNS-Anfragen deines Netzwerks aufzeichnet.',
  'logs.level.full': 'Vollständig',
  'logs.level.full.text': 'Jede Anfrage mit Client und Domain, dazu alle Statistiken.',
  'logs.level.hide-domains': 'Domains verbergen',
  'logs.level.hide-domains.text':
    'Anfragen werden mit dem Client protokolliert, aber ohne Domain. Die Statistiken bleiben, ohne die Domain-Listen.',
  'logs.level.anonymous': 'Anonym',
  'logs.level.anonymous.text': 'Wie „Domains verbergen“, und Client-Adressen werden auf ihr Netz gekürzt.',
  'logs.level.off': 'Aus',
  'logs.level.off.text': 'Kein Abfrageprotokoll und keine DNS-Statistiken. Die Statistiken des Download-Caches bleiben.',
  'logs.level.custom': 'Eigene',
  'logs.level.custom.text': 'Du wählst jeden Schalter selbst.',
  'logs.level.note':
    'Änderungen gelten für neue Daten: Was vorher aufgezeichnet wurde, bleibt, bis es abläuft oder du es löschst. Das Systemjournal (journalctl) ist von diesen Schaltern nicht erfasst.',
  'logs.queryLog': 'Abfrageprotokoll führen',
  'logs.queryLogHelp':
    'Zeichnet jede DNS-Anfrage auf. Ist es aus, werden die Statistiken trotzdem gezählt, wenn sie an sind.',
  ...
  'logs.hideDomains': 'Domains verbergen',
  'logs.hideDomainsHelp':
    'Anfragen werden als „hidden“ und ohne Antworten aufgezeichnet. Die Top-Domain-Listen werden nicht gezählt; Clients, Upstreams, Zwecke und Abfragetypen schon.',
  'logs.stats': 'DNS-Statistiken zählen',
  'logs.statsHelp':
    'Diagramme, Top-Listen, Abfragetypen und verschiedene Domains in der Übersicht und bei den Clients. Die Statistiken des Download-Caches werden immer gezählt.',
  'logs.recording.title': 'Aufzeichnung',
  'logs.recording.description': 'Was in Logs und Statistiken fehlt und wie oft sie auf die Festplatte geschrieben werden.',
  'logs.ignored': 'Ignorierte Domains',
  'logs.ignoredHelp':
    'Anfragen für diese Domains und ihre Subdomains werden wie gewohnt beantwortet und gefiltert, aber weder protokolliert noch gezählt. Eine pro Zeile, z. B. eine Verbindungsprüfung oder „lan“. Anders als verworfene Domains in den DNS-Einstellungen bekommen sie weiter eine Antwort. {count} von {max}.',
  'logs.ignoredTooMany': 'Gib höchstens {max} Domains ein.',
  'logs.addressOnly': 'Nur Adressanfragen zählen',
  'logs.addressOnlyHelp':
    'Die Statistiken zählen nur A-, AAAA- und HTTPS-Anfragen, damit Hintergrundanfragen (PTR, TXT, SRV, …) sie nicht aufblähen. Das Abfrageprotokoll und das Diagramm der Abfragetypen behalten jeden Typ.',
  'logs.flush': 'Schreibintervall',
  'logs.flushHelp':
    'Neue Log-Einträge und Zählungen werden alle {value} geschrieben. Ein längeres Intervall bedeutet weniger Schreibzugriffe auf eine SD-Karte, aber so viel geht bei einem Stromausfall verloren (gesehene Geräte: mindestens eine Minute), und Abfrageprotokoll und Minuten-Diagramme hinken so weit hinterher. Die Live-Ansichten werden nie verzögert.',
  'logs.seconds': 'Sekunden',
  'logs.retention.title': 'Aufbewahrung',
  'logs.retention.description': 'Wie lange PiCache welche Log-Daten aufbewahrt und wie groß die Log-Datenbank werden darf.',
  'logs.queryRetention': 'Abfrageprotokoll (Stunden)',
  ...
  'logs.clear.description': 'Lösche aufgezeichnete Daten jetzt, statt zu warten, bis sie ablaufen.',
  'logs.clear.queries': 'Abfrageprotokoll leeren',
  'logs.clear.queriesText':
    'Löscht jede protokollierte DNS-Anfrage. Statistiken, Download-Verlauf, Cache-Logs und der Warnverlauf bleiben.',
  'logs.clear.queriesTitle': 'Abfrageprotokoll leeren?',
  'logs.clear.queriesConfirm':
    'Jede protokollierte DNS-Anfrage wird gelöscht. Die Statistiken, der Download-Verlauf, das Cache-Anfragen-Log und der Warnverlauf bleiben erhalten. Das lässt sich nicht rückgängig machen.',
  'logs.clear.queriesDone.one': 'Abfrageprotokoll geleert ({count} Eintrag gelöscht)',
  'logs.clear.queriesDone.other': 'Abfrageprotokoll geleert ({count} Einträge gelöscht)',
  'logs.clear.stats': 'Statistiken zurücksetzen',
  'logs.clear.statsText':
    'Löscht die Statistiken von DNS und Download-Cache: Diagramme, Top-Listen und Client-Summen. Abfrageprotokoll, Download-Verlauf, Cache-Logs und der Warnverlauf bleiben.',
  'logs.clear.statsTitle': 'Statistiken zurücksetzen?',
  'logs.clear.statsConfirm':
    'Die Statistiken von DNS und Download-Cache (Diagramme, Top-Listen, Abfragetypen, Client-Summen) werden gelöscht. Das Abfrageprotokoll, der Download-Verlauf, das Cache-Anfragen-Log und der Warnverlauf bleiben erhalten. Das lässt sich nicht rückgängig machen.',
  'logs.clear.statsDone.one': 'Statistiken zurückgesetzt ({count} Zeile gelöscht)',
  'logs.clear.statsDone.other': 'Statistiken zurückgesetzt ({count} Zeilen gelöscht)',
  'logs.offer.title': 'Auch löschen, was vorher aufgezeichnet wurde?',
  'logs.offer.text':
    'Die neue Einstellung gilt ab jetzt. Vorher aufgezeichnete Daten bleiben, bis sie ablaufen. Du kannst sie jetzt löschen.',
  'logs.offer.queries': 'Abfrageprotokoll leeren',
  'logs.offer.queriesHelp': 'Jede protokollierte Anfrage mit ihren Clients und Domains.',
  'logs.offer.stats': 'Statistiken zurücksetzen',
  'logs.offer.statsHelp': 'Diagramme, Top-Listen und Client-Summen, auch die des Download-Caches.',
  'logs.offer.confirm': 'Ausgewählte Daten löschen',
  'logs.offer.keep': 'Daten behalten',

  // Anwendungsprotokoll
  'applog.adminOnly': 'Nur Admins können das Anwendungsprotokoll sehen.',
  'applog.title': 'Anwendungsprotokoll',
  'applog.description':
    'Meldungen des PiCache-Dienstes, neueste zuerst: Die letzten {capacity} werden im Speicher gehalten. Geheimnisse werden entfernt; Client-Adressen und Domains werden maskiert, wenn die Datenschutzeinstellungen das vorsehen.',
  'applog.journal':
    'Das vollständige Log steht im Systemjournal (journalctl -u picache, bei einem Container docker logs). Lass PICACHE_LOG_LEVEL dort auf info: Die Datenschutzeinstellungen gelten dafür nicht.',
  'applog.download': 'Herunterladen (NDJSON)',
  'applog.level': 'Mindeststufe',
  'applog.levelMin.debug': 'Alles (ab Debug)',
  'applog.levelMin.info': 'Ab Info',
  'applog.levelMin.warn': 'Warnungen und Fehler',
  'applog.levelMin.error': 'Nur Fehler',
  'applog.level.debug': 'Debug',
  'applog.level.info': 'Info',
  'applog.level.warn': 'Warnung',
  'applog.level.error': 'Fehler',
  'applog.component': 'Komponente',
  'applog.allComponents': 'Alle Komponenten',
  'applog.live.open': 'Live',
  'applog.live.paused': 'Pausiert',
  'applog.live.retrying': 'Verbindet neu …',
  'applog.live.connecting': 'Verbindet …',
  'applog.live.pause': 'Live-Protokoll pausieren',
  'applog.live.resume': 'Live-Protokoll fortsetzen',
  'applog.count': '{count} Einträge',
  'applog.dropped':
  ...
  'applog.debug.title': 'Debug-Protokollierung',
  'applog.debug.description':
    'Ausführlichere Meldungen für eine Weile, etwa um einem Problem nachzugehen. Sie endet von selbst und bei einem Neustart.',
  'applog.debug.base': 'Normale Stufe (PICACHE_LOG_LEVEL): {level}',
  'applog.debug.activeTitle': 'Protokollierung auf Stufe {level} ist an',
  'applog.debug.active': 'Für {target} bis {time} ({relative}).',
  'applog.debug.all': 'alle Komponenten',
  'applog.debug.end': 'Jetzt beenden',
  'applog.debug.alreadyDebug': 'Die normale Stufe ist schon die ausführlichste: Es gibt nichts einzuschalten.',
  'applog.debug.level': 'Stufe',
  'applog.debug.minutes': 'Für',
  'applog.debug.minutesUnit': 'Minuten',
  'applog.debug.start': 'Einschalten',
  'applog.debug.replace': 'Ersetzen',
  'applog.debug.started': 'Ausführliche Protokollierung an bis {time}',
  'applog.debug.ended': 'Ausführliche Protokollierung beendet',
  ...
  'health.warnings.description':
    'Warnungen und Fehler, die PiCache aufgezeichnet hat (Zustand, Speicher, Updates, Sicherungen, Sicherheit), auch ohne Benachrichtigungskanäle. 90 Tage aufbewahrt; Wiederholungen eines unbestätigten Eintrags werden zusammengefasst.',
  'health.warnings.filter': 'Angezeigte Einträge',
  'health.warnings.filterAll': 'Alle Einträge',
  'health.warnings.filterOpen': 'Nur unbestätigte',
  'health.warnings.ack': 'Bestätigen',
  'health.warnings.ackAll': 'Alle bestätigen',
  'health.warnings.ackAllDone.one': '{count} Eintrag bestätigt',
  'health.warnings.ackAllDone.other': '{count} Einträge bestätigt',
  'health.warnings.acked': 'Bestätigt {time}',
  'health.warnings.ackedBy': 'Bestätigt {time} von {user}',
  'health.warnings.count': '{count}×',
  'health.warnings.countHelp': 'Wie oft das passiert ist, während der Eintrag unbestätigt war',
  'health.warnings.first': 'Zuerst {time}',
  'health.warnings.last': 'zuletzt {time}',
  'health.warnings.more': 'Mehr anzeigen',
  'health.warnings.empty': 'Keine Warnungen aufgezeichnet',
  'health.warnings.emptyText': 'PiCache zeichnet hier Warnungen zu Zustand, Speicher, Updates, Sicherungen und Sicherheit auf.',
  'health.warnings.emptyOpen': 'Nichts zu bestätigen',
  'health.warnings.emptyOpenText': 'Alle aufgezeichneten Warnungen sind bestätigt.',

  'health.host.title': 'Ressourcen des Hosts',
  'health.host.description': 'Jede Minute vom Betriebssystem gelesen, zuletzt {time}.',
  'health.host.loadError': 'Die Ressourcen des Hosts konnten nicht geladen werden',
  'health.host.container': 'PiCache läuft in einem Container: Last, Laufzeit und Speicher sind die des Hosts.',
  'health.host.model': 'Gerät',
  'health.host.cpus': 'CPUs',
  'health.host.load': 'Last (1, 5, 15 Min.)',
  'health.host.loadHost': 'Last des Hosts (1, 5, 15 Min.)',
  'health.host.loadHigh': 'Über dem Schwellenwert',
  'health.host.uptime': 'Laufzeit des Systems',
  'health.host.uptimeHost': 'Laufzeit des Hosts',
  'health.host.memory': 'Arbeitsspeicher',
  'health.host.memoryHost': 'Arbeitsspeicher des Hosts',
  'health.host.memoryText': '{used} belegt · {available} verfügbar von {total}',
  'health.host.swap': 'Auslagerung',
  'health.host.usedOf': '{used} belegt von {total}',
  'health.host.cgroup': 'Speichergrenze des Containers',
  'health.host.cgroupService': 'Speichergrenze des PiCache-Dienstes',
  'health.host.diskData': 'Datenlaufwerk ({path})',
  'health.host.diskCache': 'Cache-Laufwerk ({path})',
  'health.host.freeOf': '{free} frei von {total} ({percent})',
  'health.host.temperatures': 'Temperaturen',
  'health.host.celsius': '{value} °C',
  'health.host.tooHot': 'Am oder über dem Schwellenwert',
  'health.host.noData': 'Auf diesem System konnten keine Werte gelesen werden.',

  'health.thresholds.title': 'Warnschwellen',
  'health.thresholds.description': 'Die Prüfung „Ressourcen des Hosts“ warnt, wenn ein Wert eine davon überschreitet.',
  'health.thresholds.loadError': 'Die Warnschwellen konnten nicht geladen werden',
  'health.thresholds.memory': 'Verfügbarer Speicher unter',
  'health.thresholds.memoryAvailableMinPercentHelp':
    'Vom Host oder von der Container-Grenze, je nachdem, was niedriger ist. 1–50 % (Standard: {def} %).',
  'health.thresholds.load': 'Last über',
  'health.thresholds.perCpu': 'pro CPU',
  'health.thresholds.loadPerCpuMaxHelp': 'Die 15-Minuten-Last geteilt durch die Anzahl der CPUs. 1–16 (Standard: {def}).',
  'health.thresholds.temperature': 'Temperatur ab',
  'health.thresholds.temperatureMaxCelsiusHelp': 'Jeder Sensor. 50–110 °C (Standard: {def} °C).',

  'health.db.title': 'Datenbanken',
  'health.db.description': 'Dateigrößen auf dem Datenlaufwerk.',
  'health.db.loadError': 'Die Größen der Datenbanken konnten nicht geladen werden',
  'health.db.picache': 'Konfiguration (picache.db)',
  'health.db.logs': 'Logs und Statistiken (logs.db)',
  'health.db.withWal': '{size} + {wal} Write-Ahead-Log',
  'health.db.cap': 'Grenze der Log-Datenbank',
  'health.db.capText': '{percent} der Grenze von {cap}',
  'health.db.capChange': 'Grenze ändern',
  'health.db.noCap': 'Keine Größengrenze',
  'health.db.index': 'Cache-Index {id}',
  'health.db.disabled': 'Die Log-Datenbank wird nicht genutzt: {reason}. Logs und Statistiken werden nicht aufbewahrt.',
  'health.db.rawPaused':
    'Auf dem Datenlaufwerk ist weniger als 1 GiB frei: Neue Log-Einträge werden erst wieder geschrieben, wenn wieder Platz ist. Statistiken werden weiter gezählt.',

  'health.bundle.title': 'Support-Paket',
  'health.bundle.description':
    'Eine ZIP-Datei für einen Fehlerbericht: Version, Einstellungen, Zustand, Listener, Netzwerkprüfung, DHCP-Status, Datenbanken, Ressourcen des Hosts und das Anwendungsprotokoll, ohne Geheimnisse und mit ersetzten Namen und öffentlichen Adressen.',
  'health.bundle.never':
    'Nie enthalten: Konten, Sitzungen, Tokens, Schlüssel, Änderungs- und Abfrageprotokoll, Cache- und Download-Logs, Clients, Leases, Reservierungen, Filterlisten und Regeln, Speicherziele, Benachrichtigungskanäle und Sicherungen.',
  'health.bundle.button': 'Support-Paket erstellen',
  'health.bundle.dialogTitle': 'Support-Paket erstellen',
  'health.bundle.intro':
    'Das Paket entsteht aus dem, was PiCache gerade weiß (kein Netzwerk-Scan), und wird auf dieses Gerät heruntergeladen. Es wird nirgendwohin gesendet.',
  'health.bundle.review': 'Prüfe die Dateien, bevor du sie teilst: Sie können noch Details deines Netzwerks enthalten.',
  'health.bundle.names': 'Geräte- und Client-Namen, MAC- und private Adressen einschließen',
  'health.bundle.namesHelp':
    'Ohne diese Option werden Namen im Anwendungsprotokoll entfernt, MAC-Adressen durch mac-1 … ersetzt, private Adressen auf ihr Netz gekürzt und Netzwerkprüfung und DHCP-Status auf Zahlen reduziert. Der eigene Hostname von PiCache und die Namen aus den Einstellungen werden immer durch name-1 … ersetzt; öffentliche Adressen werden immer gekürzt.',
  'health.bundle.password': 'Dein Passwort',
  'health.bundle.submit': 'Erstellen und herunterladen',
  'health.bundle.done': 'Support-Paket heruntergeladen',
